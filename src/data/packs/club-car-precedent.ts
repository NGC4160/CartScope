...
export const clubCarPrecedent = buildClubCarIq({
  ...
  diagramNotes: [
    ...
    "The solenoid is the main power switch. It sends big power to the motor. Its coil should read 180–190 Ω (Test Procedure 3). Do not use a 40–200 Ω parts-store range.",
  ...
  controllerName: "IQ controller",
  controllerDesc:
    "This is the IQ electric controller. Big plus power comes through the solenoid. Big minus power comes through Tow/Run. The M− wire pulses power to the motor. The gas pedal sensor (MCOR) and the Forward/Reverse switch tell it when to run. It bolts to the frame so it stays cool. Use the IQDM Diagnostic Menu (Troubleshooting Guide 1) if you have a handset. If you do not, use Troubleshooting Guide 2.",
  computerName: "Cart computer (OBC)",
  computerKind: "computer",
  computerDesc:
    "The Club Car cart computer (OBC) sits in the charger path. It also tells the solenoid when it may click (Test Procedure 2). A bad cart computer can stop charging (gray wire, TP 11). It can also block the solenoid even if the rest of the control circuit is good. PowerDrive chargers talk to this module.",
  computerFailures: [
  ...
  throttleDesc:
    "The MCOR is the gas pedal sensor on the pedal box. It has a pedal limit switch (two-pin, TP 8) and a sensor that changes ohms as you press the pedal (three-pin, TP 4). Yellow wiper is about 0.32 V with the pedal up, and 4.65 V with the pedal down. Yellow to purple is about 1 kΩ up, and 5.67–7.43 kΩ down. The IQ controller will not click the solenoid without the limit switch. If the cart is slow and yellow is not about 4.60 V at full pedal, check MCOR ohms (TP 4 step 8).",
  manualPrefix: "2006-07 Precedent IQ M&S Section 11",
  packCells: "Six 8 V batteries in a row (48 V total)",
  lockoutNote: "If the PowerDrive charger is plugged in, a safety lock stops the solenoid. The cart will not run with the cord in.",
