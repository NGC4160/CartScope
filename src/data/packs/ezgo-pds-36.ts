...
export const ezgoPds36 = buildEzgoDc({
  ...
  diagramNotes: [
    ...
    "Factory PDS sheets from the 2001+ 36 V book are in the wire library after the Fig. 9 map: F-6 intro, Fig. 7 fault codes / Fig. 8 connectors, then detailed trees Fig. 10–19 (F-10–F-19).",
  ],
  voltage: 36,
