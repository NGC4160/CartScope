...
export const ezgoRxv = buildAcDrive({
  ...
  diagramNotes: [
    ...
    "The solenoid is the main power switch. It sends pack power into the controller. The controller is a three-phase AC inverter. U–V, V–W, W–U each 0.4–0.8 Ω (errors 8976 AC Over Current, 9024 AC Short Circuit).",
  ...
  errorNotes:
    "RXV Section O error table:\n8976 AC Over Current — key cycle; U/V/W 0.4–0.8 Ω; motor then controller.\n9024 AC Short Circuit — same U/V/W then swap-controller test.\n12576 DC Bus Timeout — bus not 24 V in 10 s after key. Pack ≥ 42 V; solenoid metal pads; resistor module at B−.\n12817 DC Bus High (software, pack > 63 V) / 12818 hardware > 67 V — battery cables < 0.1 Ω to posts; solenoid drop; power resistor 0.2–0.5 Ω; resistor module.\n12833 DC Bus Low (bus < 18 V) — same power-path tree, pack ≥ 42 V.\n16912 Motor Temp High — motor ≥ 150 °C; thermocouple 400–1300 Ω (1300 Ω = 150 °C).\n17168 Heat Sink Temp High — controller ≥ 120 °C; outside sink < 80 °C.\n20753 15 V supply low — reverse alarm 100–500 Ω, relay 1–50 Ω.\n20755 5 V supply low/high — 5 V harness short.\n25104 Direction Error — FNR.\n25107 park brake startup — coil 27 ± 3 Ω.\n25108 Brake Sensor Error.",
});
