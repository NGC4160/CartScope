...
export const clubCarDsIq = buildClubCarIq({
  ...
  diagramNotes: [
    "DS-body IQ and 2008–2011 transportation IQ System share the same Precedent IQ electric tree. That means Tow/Run, cart computer safety lock, MCOR gas pedal sensor, 16-pin plug, and a 180–190 Ω click-switch coil.",
    "The Tow/Run switch is in the battery negative path. Turn it to Tow before you take battery cables off.",
    "IQ Plus transportation (supplement 103373107) is a different pack. Do not mix IQ and IQ Plus speed boxes.",
  ...
  controllerName: "IQ speed box (DS / transportation)",
  controllerDesc:
    "This is the IQ electric speed box used on DS IQ and 2008–2011 Villager/Transporter IQ System. It uses the same Diagnostic Menu (TG1) and Troubleshooting Guide 2 steps as Precedent IQ. Transportation speed boxes may use different speed tables. Check with the IQDM-P before you call a cart slow.",
  computerName: "Cart computer (OBC)",
  computerKind: "computer",
  computerDesc:
    "This is the PowerDrive cart computer on DS IQ and Villager/Transporter IQ. Click-switch safety lock (TP 2) and the gray-wire charge path (TP 11) use the same tests as Precedent IQ.",
  computerFailures: [
  ...
  throttleDesc:
    "The MCOR is the gas pedal sensor on the DS / Villager pedal group. Factory: yellow 0.32 V up → 4.65 V full. Yellow to purple 1 kΩ up → 5.67–7.43 kΩ full. The limit switch must close so the big click switch (solenoid) can turn on.",
