...
export const ezgoTxt = buildEzgoDc({
  ...
  diagramNotes: [
    "This is the 48 V TCT electric tree, not PDS. The controller is a Curtis 1206HB-5201. Section E of the 48 V TXT service manual.",
    "The solenoid is the main power switch. It sends big power to the motor. ITS factory: 1.0 V ± 0.3 V when the solenoid clicks; 2.7 V ± 0.5 V at full pedal.",
    ...
    "Power cables: CB+ to the solenoid, CB− to battery B−, A1/C from motor 4 AWG. 16-pin from the main harness.",
  ],
  voltage: 48,
  controllerName: "Curtis 1206HB-5201 TCT controller",
  controllerDesc:
    "TXT TCT electric controller, 16-pin main harness, KSI on white. Fault table is Section E: HW FAILSAFE, FIELD MISSING, M− SHORTED, CURRENT SENSE FAULT, MAIN DROPOUT 1/2, MAIN DRIVER ON/OFF, MOTOR STALL, MAIN COIL OPEN, SPEED SENSOR FAULT, MAIN WELDED, HPD, THERMAL CUTBACK, OVERVOLTAGE, LOW BATTERY VOLTAGE, THROTTLE FAULT. Response codes 1–9 (armature 0, field 0, contactor off, limp 75 %, thermal current limit, throttle scaled to 0, walk-away).",
  throttleName: "ITS (gas pedal sensor)",
  throttleDesc:
    "Solid-state gas pedal sensor (ITS) on the pedal box. Factory procedure: 1.0 V ± 0.3 V at solenoid click, 2.7 V ± 0.5 V full pedal. The plunger must enter the ITS body the right way (Figs. 10–12). THROTTLE FAULT = open or shorted wiring, or a bad ITS.",
