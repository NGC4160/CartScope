...
export const clubCarDsElectric = buildClubCarPd48({
  ...
  architecture: "PowerDrive System 48 electric · cart computer · gas pedal sensor · 190–250 Ω solenoid",
  ...
  diagramNotes: [
    ...
    "The solenoid is the main power switch. It sends big power to the motor. The coil is 190–250 Ω (Test Procedure 5). It has a one-way diode and a 250 Ω pre-charge resistor across the large posts.",
  ...
  controllerDesc:
    "This is a series electric solid-state controller. Terminal 1 (A on early units) is the 18-gauge red solenoid input. Terminals 2/3 (B/C) are the pot. B+ / B− / M− / A2 carry big power. TP 10: capacitor voltage about 48 V B+ to M− at rest. It must rise to full pack at full pedal. Clean the terminal face — leak current can look like a failed unit. Double-wrench the bus bars so you do not crack the seals.",
  motorName: "48 V series motor (3.1 hp)",
  motorDesc:
    "Direct-drive 48 V series electric motor, 3.1 hp. F&R flips the field: TP 6 Forward M− to S1 and A2 to S2; Reverse M− to S2 and A2 to S1. Take the 6-gauge white off A2 before controller output tests.",
  throttleName: "Multi-step or sweep pot (gas pedal sensor)",
  throttleDesc:
    "Two versions. Multi-step wiper (early): six ohm steps 300–4940 Ω. Sweep three-wire (serial A9529-445799+): about 0–300 Ω rest to about 5500 Ω full. Either must land in 4600–7000 Ω at full pedal or the cart will not reach speed. The pedal limit switch must be open at rest. If the solenoid clicks as soon as the key is on, the limit switch failed closed.",
