...
export const clubCarDsPdPlus = buildClubCarPd48({
  ...
  diagramNotes: [
    "This cart uses a shunt 3.2 hp motor, a rocker F&R, and a Z-plug controller. It is not a series PowerDrive 48 and not IQ.",
  ...
  controllerDesc:
    "This is a shunt electric regen controller. It always sends 48 V pulses. Pulse width follows the gas pedal sensor. Direction is flipped inside the controller (Z6 white / Z7 blue), not by an F&R rotor. Z1 red from solenoid L2 keeps leftover power stored, key ON or OFF. Z12 yellow is the charger safety lock. Z11 green switches hill-brake to regen (the cart slowing itself). Replace it as a unit. You cannot fix it in the field.",
  motorName: "48 V shunt motor (3.2 hp)",
  motorDesc:
    "Shunt electric 3.2 hp. Field current is changed on its own, apart from armature current. That is why Plus climbs better and can regen. Speed sensor on the tail (Z13 red supply, Z14 green pulse) is needed for zero-speed and pedal-up/down braking. Take A2 off before controller output tests.",
