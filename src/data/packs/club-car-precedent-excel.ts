...
export const clubCarPrecedentExcel = buildClubCarIq({
  ...
  controllerName: "Excel controller",
  controllerDesc:
    "This is the Excel electric controller used on 2008+ Precedent Excel. It uses the same solenoid / gas pedal sensor / cart computer path as IQ, with Excel software and the Excel handset. Big plus power comes through the solenoid. Big minus power comes through Tow/Run. Do not mix IQ and Excel controllers.",
  ...
  throttleDesc:
    "Same MCOR as IQ Precedent: a two-pin limit switch plus a three-pin sensor that changes ohms as you press the pedal. Yellow 0.32 V up → 4.65 V full. Yellow to purple 1 kΩ up → 5.67–7.43 kΩ full. Excel will not click the solenoid without the limit switch.",
  manualPrefix: "2008 Precedent IQ System and Excel M&S (103373101) Section 11",
  packCells: "Six 8 V batteries in a row (48 V total)",
  lockoutNote: "Excel also stops the solenoid while the charger is plugged in. Unplug J1 before you test a dead cart.",
