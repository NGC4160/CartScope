...
export const ezgoExpressS6 = buildEzgoDc({
  id: "ezgo-express-s6",
  name: "Express S6",
  fullName: "EZ-GO Express S6 Electric (48 V)",
  years: "Express S6 Electric (manual 625621) — 48 V Sepex with ITS, 24-pin J1, Run-Tow/Maintenance",
  architecture: "48 V electric · gas pedal sensor · 24-pin J1 · speed sensor · Run-Tow/Maintenance · blink-code faults",
  diagramTitle: "Power and control picture — Express S6 48 V",
  diagramNotes: [
    "This is the Express S6 electric tree from SM 625621 (shared with Express L6). It is not Express S4 High Output (manual 635085).",
  ...
  voltage: 48,
  controllerName: "Express S6 48 V electric controller",
  controllerDesc:
